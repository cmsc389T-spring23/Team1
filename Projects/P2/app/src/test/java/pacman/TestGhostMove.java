...
public class TestGhostMove extends TestCase {
  ...
  public void testGhostMove() throws FileNotFoundException {
    ...
    // Ghost1 free to move anywhere
    Location loc1 = new Location(5,5);
    PacManComponent pc1 = new PacManComponent(loc1.x, loc1.y, scale);
    PacMan ghost1 = new PacMan("ghost1", loc1, map);
    map.add("ghost1", loc1, pc1, Map.Type.PACMAN);

    // Ghost2 surrounded by walls
    Location loc2 = new Location(1,1);
    PacManComponent pc2 = new PacManComponent(loc2.x, loc2.y, scale);
    PacMan ghost2 = new PacMan("ghost2", loc2, map);
    map.add("ghost2", loc2, pc2, Map.Type.PACMAN);
